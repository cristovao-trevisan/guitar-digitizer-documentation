...
\newcommand{\printcoadvisor}{\imprimircoorientador}
...
\newcommand{\partannexes}{\partanexos}

\newcommand{\partappendices}{\partapendices}

\newcommand{\ABNTEXreducedfont}{\ABNTEXfontereduzida}
...
\newenvironment{annexesenv}{\anexosenv}{\endanexosenv}
\newenvironment{appendicesenv}{\apendicesenv}{\endapendicesenv}
\newenvironment{itemlist}{\alineas}{\endalineas}
\newenvironment{cover}{\capa}{\endcapa}
