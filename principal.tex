...
\input{pre-textual-pages/catalographic-card}
\input{pre-textual-pages/errata}
\input{pre-textual-pages/approval-sheet}
\input{pre-textual-pages/dedication}
\input{pre-textual-pages/acknowledgements}
\input{pre-textual-pages/inscription}
\input{pre-textual-pages/summarys}
...
% ----------------------------------------------------------
\input{pre-textual-pages/acronyms}

% ----------------------------------------------------------
% inserir lista símbolos
\input{pre-textual-pages/symbols}
% ----------------------------------------------------------
