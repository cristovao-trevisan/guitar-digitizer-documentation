...
\input{pre-textual-elements/summarys}
...
\include{textual-elements/introduction}

\part{Research Preparation}
\include{textual-elements/chapter-1}

\part{Useful Tips}
\include{textual-elements/chapter-2}
